                  ...
                  children: [
                    ...
                    Container(
                      ...
                      padding: const EdgeInsets.symmetric(
                        ...
                        vertical:
                            UiConstants.generalVerticalContentPadding / 1.5,
                      ),
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          padding: const EdgeInsets.symmetric(
                            vertical:
                                UiConstants.generalVerticalContentPadding /
                                    1.25,
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ListView.separated(
                                shrinkWrap: true,
                                itemCount:
                                    selectedEdu.specialAchievements.length,
                                separatorBuilder: (context, index) =>
                                    const SizedBox(
                                  height: UiConstants
                                          .generalVerticalContentPadding /
                                ...
                                itemBuilder: (context, index) {
                                  return UnorderedListItem(
                                    text:
                                        selectedEdu.specialAchievements[index],
                                  );
                                },
                              ),
                            ],
